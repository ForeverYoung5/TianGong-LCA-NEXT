import { createSource as createSourceTidas } from '@tiangong-lca/tidas-sdk';
import {
...
export function genSourceJsonOrdered(id: string, data: any) {
  const sourceTidas = createSourceTidas();
  sourceTidas.sourceDataSet = {
