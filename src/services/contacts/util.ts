import { createContact as createContactTidas } from '@tiangong-lca/tidas-sdk';
import {
...
export function genContactJsonOrdered(id: string, data: any) {
  const contactTidas = createContactTidas();
  contactTidas.contactDataSet = {
