import { createFlowProperty as createFlowPropertyTidas } from '@tiangong-lca/tidas-sdk';
import {
...
export function genFlowpropertyJsonOrdered(id: string, data: any) {
  const flowPropertyTidas = createFlowPropertyTidas();
  flowPropertyTidas.flowPropertyDataSet = {
  ...
  return flowPropertyTidas.toJSON();
}
