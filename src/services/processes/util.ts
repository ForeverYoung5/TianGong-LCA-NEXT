import { createProcess as createProcessTidas } from '@tiangong-lca/tidas-sdk';
import {
...
export function genProcessJsonOrdered(id: string, data: any) {
  ...
  const processTidas = createProcessTidas();
  processTidas.processDataSet = {
